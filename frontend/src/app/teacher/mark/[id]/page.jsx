...
export default function TeacherMarkHomeworkPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      console.error(e);
      setRow(null);
      setLoadError('Could not load this submission.');
    } finally {
      setLoading(false);
    }
  }, [id]);
  ...
  if (!row) {
    return (
      <div className="teacher-mark">
        ...
        <Link href="/teacher" className="teacher-mark__back">
          ← Back to dashboard
        </Link>
      </div>
    );
  ...
  return (
    <div className="teacher-mark">
      ...
      <div className="teacher-mark__mark-block">
        <label htmlFor="teacher-stars" className="teacher-mark__label">
          Effort
        </label>
        <select
          id="teacher-stars"
        ...
        <label htmlFor="teacher-comment" className="teacher-mark__label">
          Comment
        </label>
        <textarea
          id="teacher-comment"
