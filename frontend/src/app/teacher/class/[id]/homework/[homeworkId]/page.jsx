...
import '../../../../mark/[id]/teacher-mark.scss';
...
export default function TeacherHomeworkTemplateViewPage() {
  ...
  if (!hw || error) {
    return (
      <div className="teacher-mark">
        ...
        <Link href={`/teacher/class/${classId}?tab=homework`} className="teacher-mark__back">
          ← Back to class
        </Link>
      </div>
    );
