...
import '@/components/StudentProfileModal/student-profile-modal.scss';
...
export default function TeacherProfileModal({ isOpen, onClose, profile, onSaved }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axiosInterceptor.patch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/core/teacher-profile/`,
        payload
      );
      onSaved?.();
      onClose();
      ...
      >
        <div className="profile-modal" onClick={(e) => e.stopPropagation()}>
          <div className="profile-modal__title-row">
            <h2 id="teacher-profile-modal-title" className="profile-modal__heading">
              {displayName}
            </h2>
          ...
          <form className="profile-modal__body" onSubmit={handleSubmit}>
            ...
            <div className="profile-modal__form-col">
              <div className="profile-modal__field">
                <label className="profile-modal__field-label" htmlFor="t-prof-email">
                  Email
                </label>
                <input
                  id="t-prof-email"
              ...
              <div className="profile-modal__field">
                <label className="profile-modal__field-label" htmlFor="t-prof-pass">
              ...
              <div className="profile-modal__field">
                <label className="profile-modal__field-label" htmlFor="t-prof-pass2">
